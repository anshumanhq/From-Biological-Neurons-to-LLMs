# Master Timeline: From Biological Neurons to Large Language Models (1943–2026)
...
| :--- | :--- | :--- | :--- |
| **1943** | McCulloch & Pitts — *A Logical Calculus...* | Artificial Neuron (Threshold Logic) | ✅ Complete |
| **1949** | Hebb — *The Organization of Behavior* | Synaptic Plasticity (Hebbian Rule) | ✅ Complete |
| **1950** | Turing — *Computing Machinery and Intelligence* | AI Philosophy / Imitation Game | ✅ Complete |
| **1958** | Rosenblatt — *The Perceptron* | First Trainable Neural Network | ✅ Complete |
...
| Year | Paper / Event | Theme | Status |
| :--- | :--- | :--- | :--- |
| **1960** | Widrow & Hoff — *Adaptive Switching Circuits* | LMS / Delta Rule (Gradient Descent) | ✅ Complete |
| **1969** | Minsky & Papert — *Perceptrons* | Linear Separability / XOR Impossibility | ✅ Complete |
...
| Year | Paper / Event | Theme | Status |
| :--- | :--- | :--- | :--- |
| **1974** | Werbos — *Beyond Regression* (PhD Thesis) | Backpropagation Proposed | ✅ Complete |
| **1980** | Fukushima — *Neocognitron* | Unsupervised CNN Precursor | ✅ Complete |
| **1982** | Hopfield — *Neural Networks and Physical Systems* | Energy-Based / Associative Memory | ✅ Complete |
| **1986** | Rumelhart, Hinton & Williams — *Nature* Paper | Backpropagation Popularised | ✅ Complete |
...
| Year | Paper / Event | Theme | Status |
| :--- | :--- | :--- | :--- |
| **1989** | LeCun et al. — *Backpropagation Applied to Handwritten Zip Code Recognition* | Convolutional Neural Networks (CNNs) | ✅ Complete |
| **1990** | Jordan — *Attractor Dynamics...* | Recurrent Network (Output Feedback) | ✅ Complete |
| **1991** | Elman — *Finding Structure in Time* | Simple RNN (Hidden State) | ✅ Complete |
| **1997** | Hochreiter & Schmidhuber — *Long Short-Term Memory* | LSTM (Original, no forget gate) | ✅ Complete |
| **1998** | LeCun et al. — *Gradient-Based Learning Applied to Document Recognition* | LeNet-5 | ✅ Complete |

---

## Phase 5: Deep Learning Maturation (2006–2012)
